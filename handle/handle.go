...
func Handle[Body, Params, Response any](httpHandler HttpHandler, path string, response ResponseFunc[Body, Params, Response], options ...Options) error {
	h, err := newStruct[Body, Params, Response](options...)
	if err != nil {
		panic(err)
	}
